...
def load_data(root_dir):
    ...
    x_train = data['x'][()] # has shape of type (nbr_images, 256, 256, 3)
...
def data_generator(x_data, nb_batch=32): # version originale: y_data fournit 
    ...
    while True:
        ...
        yield x_batch #, y_batch Batch of 16 images
