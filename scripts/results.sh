...
weights=("$common_path/resnet/v0_alan/epoch_49" "$common_path/resnet/version_1/last_epoch" 
        "$common_path/resnet/version_3/last_epoch" "$common_path/resnet/version_2/epoch_49"
         ...
         "$common_path/deit/v5_alan/last_epoch" "$common_path/deit/v6_alan/last_epoch"
         "$common_path/deit/v7_alan/weights"
...
# Extractors
extractors=('resnet' 'resnet' 'resnet' 'resnet' 'deit' 'deit' 'deit' 'deit' 'deit' 'deit' 'deit' 'deit' 'deit' 'dino_resnet' 'dino_resnet' 'dino_vit'  'dino_tiny' 'dino_vit' 'dino_vit' )

# Number of features
num_features=(128 128 128 128 128 128 128 128 128 128 128 128 128 2048 2048 384 192 384 384)
